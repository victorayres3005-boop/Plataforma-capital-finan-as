...
const PUBLIC_ROUTES = ["/login", "/auth/confirm", "/api/diag-credithub", "/api/test-credithub", "/api/debug-extraction", "/api/ch-diag", "/api/goalfy/receber", "/api/cron/", "/api/debug-bureaus"];
