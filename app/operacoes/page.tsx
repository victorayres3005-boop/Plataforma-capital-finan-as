      ...
      <header className="sticky top-0 z-50" style={{ backgroundColor: "#ffffff", borderBottom: "1px solid #F1F5F9", boxShadow: "0 1px 3px rgba(0,0,0,0.06)", height: "56px" }}>
        <div className="max-w-6xl mx-auto px-6" style={{ height: "56px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            <a href="/historico" style={{ fontSize: "13px", fontWeight: 600, color: "#64748B", padding: "5px 10px", borderRadius: "6px", textDecoration: "none" }}
              className="hidden sm:flex items-center gap-1.5">
              <Clock size={14} /> Histórico
            </a>
            <a href="/operacoes" style={{ fontSize: "13px", fontWeight: 600, color: "#203b88", padding: "5px 10px", borderRadius: "6px", textDecoration: "none", background: "#EFF6FF" }}
              className="hidden sm:flex items-center gap-1.5">
              <TrendingUp size={14} /> Operações
            </a>
            <a href="/ajuda" className="hidden sm:flex items-center justify-center" style={{ color: "#94A3B8", padding: "6px", borderRadius: "6px" }}>
              <HelpCircle size={18} />
            </a>
            <a href="/configuracoes" className="hidden sm:flex items-center justify-center" style={{ color: "#94A3B8", padding: "6px", borderRadius: "6px" }}>
              <Settings size={18} />
            </a>
            {!authLoading && user && (
              <>
                <div className="relative" style={{ marginLeft: "4px" }}>
                  <button onClick={() => setShowNotifications(p => !p)} style={{ position: "relative", width: "32px", height: "32px", display: "flex", alignItems: "center", justifyContent: "center", color: "#94A3B8", borderRadius: "6px", border: "none", background: "transparent", cursor: "pointer" }}>
                    <Bell size={18} />
                    {unreadCount > 0 && <span style={{ position: "absolute", top: "-2px", right: "-2px", minWidth: "16px", height: "16px", borderRadius: "99px", background: "#22c55e", color: "white", fontSize: "10px", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center" }}>{unreadCount}</span>}
                  </button>
                  {showNotifications && (
                    <div className="absolute right-0 bg-white rounded-xl border border-[#E2E8F0] shadow-lg z-50 overflow-hidden" style={{ top: "40px", width: "280px" }}>
                      <div className="px-4 py-3 bg-[#F8FAFC] border-b border-[#E2E8F0]">
                        <p className="text-xs font-bold text-[#374151]">Notificações</p>
                      </div>
                ...
                <a href="/perfil" className="hidden sm:flex items-center gap-2" style={{ padding: "4px 8px", borderRadius: "8px", textDecoration: "none", marginLeft: "4px" }}>
                ...
                <button onClick={signOut} className="hidden sm:flex items-center gap-1.5" style={{ fontSize: "13px", color: "#94A3B8", background: "transparent", border: "none", cursor: "pointer", padding: "5px 8px", borderRadius: "6px" }}>
                  <LogOut size={14} /> Sair
                </button>
              </>
            )}
            {!authLoading && !user && (
              <a href="/login" className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider px-5 py-2 rounded-full text-white" style={{ backgroundColor: "#73b815" }}>
                <User size={13} /> Entrar
              </a>
            )}
          </div>
